...
export default function Contacts() {
  ...
  <div className="container mx-auto text-center">
    <h2 className="text-base md:text-3xl font-semibold pt-6 mb-6 text-white font-mono">Let&apos;s get in touch</h2>
    <div className="max-w-md pb-6 pl-2 md:pl-6 mx-auto">
      {contacts.map((contact, idy) => (
        <div className="flex items-center mb-4" key={idy}>
          {contact.icon}
          <p className="text-white font-mono ml-4 text-sm md:text-base">
